...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-primary-50 relative overflow-hidden flex items-center justify-center">
            {/* Animated Background */}
            <div className="fixed inset-0 z-0 pointer-events-none">
                ...
                <motion.div
                    ...
                    className="absolute top-0 left-0 w-96 h-96 bg-primary-400/20 rounded-full blur-3xl"
                />
                <motion.div
                    animate={{ x: [0, -100, 0], y: [0, 100, 0], scale: [1, 1.3, 1] }}
                    transition={{ duration: 25, repeat: Infinity, ease: "easeInOut" }}
                    className="absolute bottom-0 right-0 w-96 h-96 bg-primary-300/20 rounded-full blur-3xl"
                />
            </div>
            ...
            <div className="relative z-10 w-full max-w-md px-6">
                <motion.div
                    ...
                    className="glass-card rounded-3xl shadow-mac p-8"
                >
                    {/* Logo */}
                    <div className="flex justify-center mb-6">
                        <Link to="/" className="flex items-center space-x-3">
                            <img src="/scalezix_logo.png" alt="Scalezix" className="w-16 h-16 rounded-xl shadow-lg" />
                        </Link>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <motion.button
                            ...
                            whileTap={{ scale: 0.98 }}
                            className="flex items-center justify-center px-4 py-3 border border-gray-200 rounded-xl hover:bg-gray-50 transition-all duration-300 disabled:opacity-50"
                        >
                    ...
                    <div className="mt-8 text-center text-sm text-gray-600">
                        ...
                        <Link to="/signup" className="text-primary-500 hover:text-primary-600 font-semibold transition-colors duration-300">
                            Sign up for free
                        </Link>
                    </div>
