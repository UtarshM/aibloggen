/**
 * Login Page - MacBook Style Premium UI 2025
 * Primary Color: #52B2BF
 * Clean, modern authentication design
 * 
    ...
    const handleGoogleLogin = async () => {
        ...
        try {
            ...
            if (response.data.authUrl) {
                ...
                setError(response.data.message || 'Google login not configured');
            }
        } catch (err) {
            const errorMsg = err.response?.data?.message || err.response?.data?.error || 'Google login is not available';
            setError(errorMsg);
        } finally {
            setLoading(false);
        }
                ...
                <div className="relative z-10 flex flex-col justify-center px-16 text-white">
                    ...
                    >
                        ...
                        <h1 className="text-4xl font-bold mb-4 leading-tight">
                            Welcome back to your<br />AI Marketing Hub
                        </h1>
                        <p className="text-primary-100 text-lg max-w-md">
                            Access powerful AI tools to create content, analyze SEO, and grow your business.
                        </p>
                ...
                >
                    ...
                    <div className="bg-white rounded-2xl shadow-soft-xl p-8 border border-gray-100">
                        ...
                        <motion.button
                            ...
                            whileTap={{ scale: 0.98 }}
                            className="w-full flex items-center justify-center gap-3 px-4 py-3.5 border border-gray-200 rounded-xl hover:bg-gray-50 hover:border-gray-300 transition-all disabled:opacity-50"
                        >
