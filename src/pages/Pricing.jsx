...
const plans = [
    {
        ...
        features: [
            ...
            { text: 'SEO Automation & Optimization', included: true },
            { text: 'Basic Analytics Dashboard', included: true },
            { text: '5 Projects', included: true },
            { text: 'Email Support', included: true },
            { text: 'Automated Client Reporting', included: false, locked: true },
            { text: 'Campaign Performance Optimization', included: false, locked: true },
            { text: 'Client Onboarding Automation', included: false, locked: true },
            { text: 'Social Media Management', included: false, locked: true },
    ...
    },
    {
        ...
        features: [
            ...
            { text: 'Automated Client Reporting', included: true },
            { text: 'Campaign Performance Optimization', included: true },
            { text: 'Client Onboarding Automation', included: true },
